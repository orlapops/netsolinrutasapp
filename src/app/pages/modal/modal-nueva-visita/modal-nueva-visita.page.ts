...
export class ModalNuevaVisitaPage implements OnInit {
  ...
  mostrar_camara(){
    ...
    this.camera.getPicture(optionscam).then((imageData) => {
      ...
      this._clientes.actualizaimagenClientefirebase('1037651402','0', -74 ,12 ,this.imagenPreview);
     }, (err) => {
      // Handle error
      ...
      this._clientes.actualizaimagenClientefirebase('1037651402','0',-74,12, imgprueba);
